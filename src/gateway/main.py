...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    redis_stream = RedisStreamService(platform.redis_url)
    logger.info(f"Redis stream service initialized (url={platform.redis_url})")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title=gateway.service_name, lifespan=lifespan)
    ...
    app.add_middleware(
        CORSMiddleware,
        allow_origins=gateway.cors_allow_origins,
