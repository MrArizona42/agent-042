...
def _source_attestation(
    ...
    try:
        source_instance_ids = resolve_corpus_source_instance_ids(
            catalog,
            kb_id=request.kb_id,
...
def plan_build(
    ...
    *,
    ...
    try:
        ...
        return result.model_copy(update={"errors": [str(exc)]})
