"""Tests for the control-plane ORM models in `clients.db.models`.
...
class TestRagReleaseBuildRow:
    def test_table_compiles(self):
        from clients.db.models import RagReleaseBuildRow
...
class TestRagAliasDeploymentRow:
    def test_table_compiles_with_release_foreign_key(self):
        from clients.db.models import RagAliasDeploymentRow
